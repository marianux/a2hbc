function ann = AnnotationFilterConvert(ann, recording_format)
...
%%%%%%%%%%%%%%%%%%%%%
    ...
    iLabListsTranslations = [ ...
        ...% ISHNE labelling:  'N' 'V' 'S' 'C' 'B' 'P' 'X' 'Q' '�' 
                                1:size(cTranslationMatrix,1);
                                1   3   2   6   1   5   6   5   6;
                                1   3   2   5   1   3   5   4   5;
                                2   1   1   4   2   4   4   4   4;
...
%%%%%%%%%%%%%%%%%%%
    ...
    iLabListsTranslations = [ ...
        ...% MITBIH labelling: 'N' '�' 'L' 'R' 'A' 'a' 'J' 'S' 'V' 'F' '[' '!' ']' 'e' 'j' 'E' '/' 'f' 'x' 'p' 'Q' '|' '?' '+' 'r' 's' 'B' 'n' '�'
                                1:size(cTranslationMatrix,1);
...
%Convert to AAMI2 labeling
ann.anntyp = colvec(iLabListsTranslations( 3, ann_types_idx(bValidBeats)));
